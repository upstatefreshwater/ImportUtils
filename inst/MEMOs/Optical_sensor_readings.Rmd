...
```{r, warning = FALSE, message = FALSE,echo=FALSE,include=TRUE,fig.align='left',fig.width=7,fig.height=3, fig.cap='Figure 3: Turbidity data within the 9 m stationary block.'}
...
```{r echo=FALSE, fig.align='left', fig.cap='Figure 3: Lagged differences in turbidity data', fig.height=4, fig.width=7, message=FALSE, warning=FALSE, include=TRUE}
dplot_dat <- 
pdat %>% 
...
```{r echo=FALSE, fig.align='left', fig.cap='Figure 5: Complete chlorophyll cast data.', fig.height=3, fig.width=7, message=FALSE, warning=FALSE, include=TRUE}
...
```{r echo=FALSE, fig.align='left', fig.cap='Figure 6: Complete BGA cast data.', fig.height=3, fig.width=7, message=FALSE, warning=FALSE, include=TRUE}
